...
var _user$project$Main$saveUserName = _elm_lang$core$Native_Platform.outgoingPort(
	'saveUserName',
	function (v) {
		return v;
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'UpdateUsername') {
			return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Main$saveUserName(model)
			};
		}
	});
var _user$project$Main$userNameFromLocalStorage = _elm_lang$core$Native_Platform.incomingPort('userNameFromLocalStorage', _elm_lang$core$Json_Decode$string);
var _user$project$Main$SaveUserName = {ctor: 'SaveUserName'};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Enter your username'),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SaveUserName),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Save in Local Storage'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$userNameFromLocalStorage(_user$project$Main$UpdateUsername);
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SaveUserName":[],"UpdateUsername":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
