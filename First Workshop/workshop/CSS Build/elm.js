...
var author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('flex w-100 h-100 justify-center items-center')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('This is a cool header we changed')
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							elm$html$Html$text('stylish text')
						]))
				]))
		]));
